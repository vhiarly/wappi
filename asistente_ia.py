...
_COMANDOS = {
    ...
    "citas": (
        "mis citas hoy — ver citas de hoy\n"
        "   Ejemplo: mis citas hoy\n"
        "mis citas semana — ver citas de los proximos 7 dias\n"
        "   Ejemplo: mis citas semana\n"
        "ocupado hasta [hora] — bloquear agenda hasta esa hora\n"
        "   Ejemplo: ocupado hasta 3pm\n"
        "no disponible — bloquear el resto del dia\n"
        "libre [dia] — bloquear un dia completo\n"
        "   Ejemplo: libre lunes\n"
        "confirmar pago [numero] — aprobar cita cuando revisaste el comprobante\n"
        "   Ejemplo: confirmar pago 18091234567\n"
        "rechazar pago [numero] — rechazar comprobante invalido\n"
        "   Ejemplo: rechazar pago 18091234567\n"
        "chat [numero] — abrir canal directo con un cliente que ya pago pero hay un conflicto de agenda (30 min)\n"
        "   Ejemplo: chat 18091234567\n"
        "cerrar chat [numero] — cerrar el canal cuando llegaron a un acuerdo\n"
        "   Ejemplo: cerrar chat 18091234567\n"
        "comprobante reembolso [numero] — enviarle al cliente el comprobante de su devolucion (adjunta la foto al mensaje)\n"
        "   Ejemplo: comprobante reembolso 18091234567"
    ),
}
